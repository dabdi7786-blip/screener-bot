...
_CATEGORY_KEYWORDS: dict[str, tuple[str, ...]] = {
    ...
    "URANIUM_NUCLEAR": (
        ...
        "rosatom", "haleu", "russian uranium", "chinese uranium",
        "china uranium", "uranium sanctions", "uranium import ban",
        "china nuclear", "cnnc",
    ),
    "AI_SEMIS": (
...
_IMPACT_RULES: dict[str, tuple[tuple[str, str, str, str], ...]] = {
    ...
    "URANIUM_NUCLEAR": (
        ("uranium import ban", "HIGH", "Uranium", "запрет импорта российского урана → предложение/цены"),
        ("uranium sanctions", "HIGH", "Uranium", "санкции на уран → предложение на рынке"),
        ("export restriction", "MEDIUM", "Uranium", "ограничение экспорта урана → предложение на рынке"),
        ("rosatom", "MEDIUM", "Uranium", "санкции/ограничения на Росатом → поставки урана"),
        ("russian uranium", "MEDIUM", "Uranium", "санкции на российский уран → предложение на рынке"),
        ("china uranium", "MEDIUM", "Uranium", "урановые мощности Китая → мировой спрос/предложение"),
        ("chinese uranium", "MEDIUM", "Uranium", "урановые мощности Китая → мировой спрос/предложение"),
        ("china nuclear", "MEDIUM", "Uranium/Nuclear fuel", "ограничения на ядерные технологии для Китая"),
        ("haleu", "MEDIUM", "Uranium/Nuclear fuel", "ограничения на HALEU → топливо для новых реакторов"),
